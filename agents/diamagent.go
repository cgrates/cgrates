...
func (da *DiameterAgent) V1DisconnectSession(ctx *context.Context, args utils.AttrDisconnectSession, reply *string) (err error) {
	...
	case utils.MetaRAR:
		return da.V1AlterSessions(ctx, engine.CGREvent{Event: args.EventStart}, reply)
	default:
...
func (da *DiameterAgent) V1AlterSessions(ctx *context.Context, cgrEv engine.CGREvent, reply *string) (err error) {
