...
ACT_TOPUP,*topup_reset,,,balance_sms,*sms,,,,,*unlimited,,1000000,,,,`,
			utils.ChargersCsv: `#Tenant,ID,FilterIDs,ActivationInterval,RunID,AttributeIDs,Weight
cgrates.org,DEFAULT,*string:~*req.Account:1001,,*default,*none,0`,
		},
...
"data_db": {
	...
	"items":{
		...
		"*resource_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*resources": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*ranking_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*rankings": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*trend_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*trends": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*statqueue_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*statqueues": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*threshold_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*thresholds": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*filters": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		"*route_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
		...
		"*dispatcher_hosts": {"limit": -1, "ttl": "", "static_ttl": false, "remote": true, "replicate": false},
