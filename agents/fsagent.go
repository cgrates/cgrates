...
// DisconnectWarning is called when call goes under the minimum duration threshold, so FreeSWITCH can play an announcement message
func (fsa *FSsessions) DisconnectWarning(args map[string]interface{}, reply *string) (err error) {
