...
func TestUpdateDiamMsgFromNavMap2(t *testing.T) {
	...
	nM.Set(utils.NewPathToItemFromSlice([]string{"Multiple-Services-Credit-Control", "Final-Unit-Indication", "Redirect-Server", "Redirect-Address-Type[1]"}), itm)
...
func TestUpdateDiamMsgFromNavMap4(t *testing.T) {
	...
	nM.Set(utils.NewPathToItemFromSlice(itm.Path), &utils.NMSlice{itm, itm2})
