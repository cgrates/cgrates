...
func TestApierCdrServer(t *testing.T) {
	...
	cdrForm1 := url.Values{utils.ACCID: []string{"dsafdsaf"}, utils.OriginHost: []string{"192.168.1.1"}, utils.REQTYPE: []string{utils.META_RATED},
	...
	cdrForm2 := url.Values{utils.ACCID: []string{"adsafdsaf"}, utils.OriginHost: []string{"192.168.1.1"}, utils.REQTYPE: []string{utils.META_RATED},
		utils.Tenant: []string{"cgrates.org"}, utils.CATEGORY: []string{"call"}, utils.Account: []string{"1001"}, utils.SUBJECT: []string{"1001"}, utils.Destination: []string{"1002"},
