...
func testV1FIdxSetThresholdProfile(t *testing.T) {
	...
	var result string
	if err := tFIdxRpc.Call(utils.ApierV1SetFilter, filter, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
	if err := tFIdxRpc.Call(utils.ApierV1GetThresholdProfile,
	...
	if err := tFIdxRpc.Call(utils.ApierV1SetThresholdProfile, tPrfl, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveFilterIndexes, &AttrRemFilterIndexes{
...
func testV1FIdxSecondComputeThresholdsIndexes(t *testing.T) {
	...
	var result string
	if err := tFIdxRpc.Call(utils.ApierV1ComputeFilterIndexIDs,
...
func testV1FIdxRemoveThresholdProfile(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveThresholdProfile,
...
func testV1FIdxSetStatQueueProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1GetStatQueueProfile,
		&utils.TenantID{Tenant: tenant, ID: "TEST_PROFILE1"}, &reply); err == nil ||
		err.Error() != utils.ErrNotFound.Error() {
		t.Error(err)
	}
	...
	if err := tFIdxRpc.Call(utils.ApierV1SetStatQueueProfile, statConfig, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FIdxSecondComputeStatQueueProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(
		utils.ApierV1ComputeFilterIndexIDs, utils.ArgsComputeFilterIndexIDs{
			Tenant:  tenant,
...
func testV1FIdxRemoveStatQueueProfile(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveStatQueueProfile,
		&utils.TenantID{Tenant: tenant, ID: "TEST_PROFILE1"}, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
...
func testV1FIdxSetResourceProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1GetResourceProfile, &utils.TenantID{Tenant: tenant, ID: "RCFG1"},
	...
	if err := tFIdxRpc.Call(utils.ApierV1SetResourceProfile, rlsConfig, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FIdxSetSecondResourceProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1GetResourceProfile, &utils.TenantID{Tenant: tenant, ID: "RCFG2"},
		&reply); err == nil || err.Error() != utils.ErrNotFound.Error() {
		t.Error(err)
	}
	rlsConfig = &ResourceWithCache{
...
func testV1FIdxRemoveResourceProfile(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveResourceProfile,
...
func testV1FIdxSetSupplierProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1GetSupplierProfile,
		&utils.TenantID{Tenant: tenant, ID: "TEST_PROFILE1"}, &reply); err == nil ||
		err.Error() != utils.ErrNotFound.Error() {
		t.Error(err)
	}
	...
	if err := tFIdxRpc.Call(utils.ApierV1SetSupplierProfile, splPrf, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FIdxRemoveSupplierProfile(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveSupplierProfile,
...
func testV1FIdxSetAttributeProfileIndexes(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1SetAttributeProfile, alsPrf, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FIdxRemoveAttributeProfile(t *testing.T) {
	...
	if err := tFIdxRpc.Call(utils.ApierV1RemoveAttributeProfile, &utils.TenantIDWithCache{
		Tenant: tenant,
...
func testV1FIdxSetDispatcherProfile(t *testing.T) {
	...
	var indexes []string
	if err := tFIdxRpc.Call(utils.ApierV1GetFilterIndexes, arg,
		&indexes); err.Error() != utils.ErrNotFound.Error() {
		t.Error(err)
	}
