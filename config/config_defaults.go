		...
		"data":[											// data profiles to load
			...
			},
			{
				...
				"fields": [
					...
					{"tag": "BalanceType", "path": "Balances[<~*req.6>].Type", "type": "*variable", "value": "~*req.9","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceUnits", "path": "Balances[<~*req.6>].Units", "type": "*variable", "value": "~*req.10","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceUnitFactors", "path": "Balances[<~*req.6>].UnitFactors", "type": "*variable", "value": "~*req.11","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceOpts", "path": "Balances[<~*req.6>].Opts", "type": "*variable", "value": "~*req.12","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceCostIncrements", "path": "Balances[<~*req.6>].CostIncrements", "type": "*variable", "value": "~*req.13","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceAttributeIDs", "path": "Balances[<~*req.6>].AttributeIDs", "type": "*variable", "value": "~*req.14","filters": ["*notempty:~*req.6:"]},
					{"tag": "BalanceRateProfileIDs", "path": "Balances[<~*req.6>].RateProfileIDs", "type": "*variable", "value": "~*req.15","filters": ["*notempty:~*req.6:"]},
