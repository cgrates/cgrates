...
"caches":{
	...
	"*reverse_filter_indexes" : {"limit": -1, "ttl": "", "static_ttl": false}, 				    // control reverse filter indexes caching
...
"asterisk_agent": {
	...
	//"alterable_fields": [],		// additional event fields allowed to be updated from new events, beyond the default ones
