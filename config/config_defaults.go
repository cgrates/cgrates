...
"stor_db": {								// database used to store offline tariff plans and CDRs
	...
	"items":{
		...
		"*tp_action_profiles": {"limit": -1, "ttl": "", "static_ttl": false, "remote":false, "replicate":false},
		"*tp_accounts": {"limit": -1, "ttl": "", "static_ttl": false, "remote":false, "replicate":false},
		"*versions": {"limit": -1, "ttl": "", "static_ttl": false, "remote":false, "replicate":false}, 
	},
},
		...
		"data":[											// data profiles to load
			...
			},
			{
				...
				"fields": [
					...
					{"tag": "AttributeFilterIDs", "path": "Attributes.FilterIDs", "type": "*variable", "value": "~*req.4"},
