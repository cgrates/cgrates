...
func testCGRConfigReloadERs(t *testing.T) {
	...
	content := []*FCTemplate{
		&FCTemplate{Tag: utils.ToR, Path: utils.MetaCgreq + utils.NestingSep + utils.ToR, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.ToR}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.2", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.ToR}},
		&FCTemplate{Tag: utils.OriginID, Path: utils.MetaCgreq + utils.NestingSep + utils.OriginID, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.OriginID}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.3", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.OriginID}},
		&FCTemplate{Tag: utils.RequestType, Path: utils.MetaCgreq + utils.NestingSep + utils.RequestType, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.RequestType}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.4", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.RequestType}},
		&FCTemplate{Tag: utils.Tenant, Path: utils.MetaCgreq + utils.NestingSep + utils.Tenant, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Tenant}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.6", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Tenant}},
		&FCTemplate{Tag: utils.Category, Path: utils.MetaCgreq + utils.NestingSep + utils.Category, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Category}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.7", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Category}},
		&FCTemplate{Tag: utils.Account, Path: utils.MetaCgreq + utils.NestingSep + utils.Account, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Account}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.8", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Account}},
		&FCTemplate{Tag: utils.Subject, Path: utils.MetaCgreq + utils.NestingSep + utils.Subject, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Subject}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.9", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Subject}},
		&FCTemplate{Tag: utils.Destination, Path: utils.MetaCgreq + utils.NestingSep + utils.Destination, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Destination}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.10", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Destination}},
		&FCTemplate{Tag: utils.SetupTime, Path: utils.MetaCgreq + utils.NestingSep + utils.SetupTime, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.SetupTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.11", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.SetupTime}},
		&FCTemplate{Tag: utils.AnswerTime, Path: utils.MetaCgreq + utils.NestingSep + utils.AnswerTime, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.AnswerTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.12", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.AnswerTime}},
		&FCTemplate{Tag: utils.Usage, Path: utils.MetaCgreq + utils.NestingSep + utils.Usage, pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Usage}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.13", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Usage}},
	}
	expAttr := &ERsCfg{
		Enabled:       true,
