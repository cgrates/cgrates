...
func testCGRConfigReloadERs(t *testing.T) {
	...
	content := []*FCTemplate{
		&FCTemplate{Tag: utils.ToR, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.ToR}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.2", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.ToR}},
		&FCTemplate{Tag: utils.OriginID, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.OriginID}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.3", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.OriginID}},
		&FCTemplate{Tag: utils.RequestType, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.RequestType}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.4", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.RequestType}},
		&FCTemplate{Tag: utils.Tenant, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Tenant}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.6", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Tenant}},
		&FCTemplate{Tag: utils.Category, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Category}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.7", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Category}},
		&FCTemplate{Tag: utils.Account, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Account}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.8", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Account}},
		&FCTemplate{Tag: utils.Subject, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Subject}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.9", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Subject}},
		&FCTemplate{Tag: utils.Destination, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Destination}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.10", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Destination}},
		&FCTemplate{Tag: utils.SetupTime, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.SetupTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.11", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.SetupTime}},
		&FCTemplate{Tag: utils.AnswerTime, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.AnswerTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.12", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.AnswerTime}},
		&FCTemplate{Tag: utils.Usage, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Usage}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.13", true, utils.INFIELD_SEP), Mandatory: true, PathSlice: []string{utils.MetaCgreq, utils.Usage}},
	}
	expAttr := &ERsCfg{
		Enabled:       true,
...
func testCgrCfgV1ReloadConfigSection(t *testing.T) {
	...
	content := []interface{}{
		map[string]interface{}{
			...
			"CostShiftDigits": 0,
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "ToR", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "ToR"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "OriginID", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "OriginID"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "RequestType", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "RequestType"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Tenant", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Tenant"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Category", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Category"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Account", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Account"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Subject", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Subject"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Destination", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Destination"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "SetupTime", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "SetupTime"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "AnswerTime", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "AnswerTime"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
		...
		map[string]interface{}{
			...
			"Path": []interface{}{
				map[string]interface{}{"Field": "*cgreq", "Index": nil},
				map[string]interface{}{"Field": "Usage", "Index": nil},
			},
			"PathSlice":        []interface{}{"*cgreq", "Usage"},
			"Filters":          nil,
			"Layout":           "",
			"Mandatory":        true,
			"MaskDestID":       "",
