...
func testCGRConfigReloadERs(t *testing.T) {
	...
	content := []*FCTemplate{
		&FCTemplate{Tag: utils.ToR, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.ToR}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.2", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.OriginID, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.OriginID}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.3", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.RequestType, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.RequestType}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.4", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Tenant, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Tenant}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.6", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Category, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Category}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.7", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Account, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Account}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.8", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Subject, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Subject}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.9", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Destination, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Destination}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.10", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.SetupTime, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.SetupTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.11", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.AnswerTime, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.AnswerTime}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.12", true, utils.INFIELD_SEP), Mandatory: true},
		&FCTemplate{Tag: utils.Usage, Path: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Usage}}, Type: utils.MetaVariable, Value: NewRSRParsersMustCompile("~*req.13", true, utils.INFIELD_SEP), Mandatory: true},
	}
	expAttr := &ERsCfg{
		Enabled:       true,
