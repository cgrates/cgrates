		...
		utils.MetaCdrLog: {
			{
				...
				Path:      utils.StringPointer("*rep.ToR"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("OriginHost"),
				Path:      utils.StringPointer("*rep.OriginHost"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.RequestType"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.Tenant"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.Account"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.Subject"),
				Type:      utils.StringPointer(utils.MetaVariable),
				Value:     utils.StringPointer("~*req.Account"),
				Mandatory: utils.BoolPointer(true),
			},
			{
				...
				Path:      utils.StringPointer("*rep.Cost"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.Source"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.Usage"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			{
				Tag:       utils.StringPointer("RunID"),
				Path:      utils.StringPointer("*rep.RunID"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.SetupTime"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			},
			{
				...
				Path:      utils.StringPointer("*rep.AnswerTime"),
				Type:      utils.StringPointer(utils.MetaConstant),
				Value:     utils.StringPointer("*now"),
				Mandatory: utils.BoolPointer(true),
			},
			{
				...
				Path:      utils.StringPointer("*rep.PreRated"),
				Type:      utils.StringPointer(utils.MetaConstant),
