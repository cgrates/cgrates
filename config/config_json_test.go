	...
	eCfg := FcTemplatesJsonCfg{
		"*fsr": {
				...
				Value: utils.StringPointer("FS_;~*req.Event-Name")},
			{
				...
				Type:    utils.StringPointer(utils.MetaConstant),
				Filters: &[]string{"*string:*req.variable_process_ur:false"},
		...
		utils.MetaUrLog: {
			{
				Tag:       utils.StringPointer("ToR"),
				Path:      utils.StringPointer("*ur.ToR"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("OriginHost"),
				Path:      utils.StringPointer("*ur.OriginHost"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			{
				Tag:       utils.StringPointer("RequestType"),
				Path:      utils.StringPointer("*ur.RequestType"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			{
				Tag:       utils.StringPointer("Tenant"),
				Path:      utils.StringPointer("*ur.Tenant"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("Account"),
				Path:      utils.StringPointer("*ur.Account"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("Subject"),
				Path:      utils.StringPointer("*ur.Subject"),
				Type:      utils.StringPointer(utils.MetaVariable),
				Value:     utils.StringPointer("~*req.Account"),
				Mandatory: utils.BoolPointer(true),
			},
			{
				Tag:       utils.StringPointer("Cost"),
				Path:      utils.StringPointer("*ur.Cost"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("Source"),
				Path:      utils.StringPointer("*ur.Source"),
				Type:      utils.StringPointer(utils.MetaConstant),
				Value:     utils.StringPointer(utils.MetaUrLog),
				Mandatory: utils.BoolPointer(true),
			},
			{
				Tag:       utils.StringPointer("Usage"),
				Path:      utils.StringPointer("*ur.Usage"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			{
				Tag:       utils.StringPointer("RunID"),
				Path:      utils.StringPointer("*ur.RunID"),
				Type:      utils.StringPointer(utils.MetaVariable),
			...
			{
				Tag:       utils.StringPointer("SetupTime"),
				Path:      utils.StringPointer("*ur.SetupTime"),
				Type:      utils.StringPointer(utils.MetaConstant),
			...
			{
				Tag:       utils.StringPointer("AnswerTime"),
				Path:      utils.StringPointer("*ur.AnswerTime"),
				Type:      utils.StringPointer(utils.MetaConstant),
				Value:     utils.StringPointer("*now"),
				Mandatory: utils.BoolPointer(true),
			},
			{
				...
				Path:      utils.StringPointer("*ur.PreRated"),
				Type:      utils.StringPointer(utils.MetaConstant),
