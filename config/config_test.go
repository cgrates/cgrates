...
func TestV1GetConfigAsJSONGeneral(t *testing.T) {
	...
	if cfgCgr, err := NewCGRConfigFromJSONStringWithDefaults(strJSON); err != nil {
		t.Error(err)
	} else if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: GeneralJSON}, &reply); err != nil {
		t.Error(err)
...
func TestV1GetConfigAsJSONDataDB(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: DataDBJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONStorDB(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: StorDBJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONTls(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: TlsJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONTCache(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: CacheJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONTListen(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: ListenJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONAccounts(t *testing.T) {
	...
	cfg := NewDefaultCGRConfig()
	if err := cfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: AccountSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONHTTP(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: HTTPJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONFilterS(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: FilterSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONCdrs(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: CDRsJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONFreeSwitchAgent(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: FreeSWITCHAgentJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONFKamailioAgent(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: KamailioAgentJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONAsteriskAgent(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: AsteriskAgentJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONADiameterAgent(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: DiameterAgentJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONARadiusAgent(t *testing.T) {
	...
	cfgCgr := NewDefaultCGRConfig()
	if err := cfgCgr.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: RadiusAgentJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONAttributes(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: AttributeSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONChargerS(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: ChargerSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONResourceS(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: ResourceSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONStatS(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: StatSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONThresholdS(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: ThresholdSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONSureTax(t *testing.T) {
	...
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: SureTaxJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONLoaders(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: LoaderSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONCgrMigrator(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: MigratorJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONApierS(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: AdminSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONApiBan(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: APIBanJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONRPCConns(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: RPCConnsJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONMailer(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: MailerJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONAnalyzer(t *testing.T) {
	...
	cgrCfg := NewDefaultCGRConfig()
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: AnalyzerSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
...
func TestV1GetConfigAsJSONCoreS(t *testing.T) {
	...
	if err := cgrCfg.V1GetConfigAsJSON(&SectionWithAPIOpts{Section: CoreSJSON}, &reply); err != nil {
		t.Error(err)
	} else if expected != reply {
		t.Errorf("Expected %+v \n, received %+v", expected, reply)
	}
