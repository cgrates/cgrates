...
func TestV1GetConfigAsJSONRouteS(t *testing.T) {
	var reply string
	expected := `{"routes":{"accounts_conns":[],"attributes_conns":[],"default_ratio":1,"enabled":false,"indexed_selects":true,"nested_fields":false,"opts":{"*context":{"*default":"*routes"},"*ignoreErrors":{"*default":false},"*limit":{},"*maxCost":{"*default":""},"*offset":{},"*profileCount":{"*default":1},"*usage":{"*default":"60000000000"}},"prefix_indexed_fields":[],"rates_conns":[],"resources_conns":[],"stats_conns":[],"suffix_indexed_fields":[]}}`
	cgrCfg := NewDefaultCGRConfig()
