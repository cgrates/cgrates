...
func TestV1GetConfigAsJSONAnalyzer(t *testing.T) {
	var reply string
	expected := `{"analyzers":{"cleanupInterval":"1h0m0s","dbPath":"/var/spool/cgrates/analyzers","eesConns":[],"enabled":false,"indexType":"*scorch","opts":{"*exporterIDs":[]},"ttl":"24h0m0s"}}`
	cgrCfg := NewDefaultCGRConfig()
