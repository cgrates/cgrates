	...
	eCacheCfg := &CacheCfg{
		Partitions: map[string]*CacheParamCfg{
			...
			utils.CacheActionProfiles: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
			utils.CacheAccountProfiles: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
			...
			utils.CacheActionProfilesFilterIndexes: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
			utils.CacheAccountProfilesFilterIndexes: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
			...
			utils.CacheTBLTPRateProfiles: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
			utils.CacheTBLTPAccountProfiles: {Limit: -1,
				TTL: 0, StaticTTL: false, Precache: false},
...
func TestV1GetConfigAsJSONCdrs(t *testing.T) {
	var reply string
	expected := `{"cdrs":{"actions_conns":[],"attributes_conns":[],"chargers_conns":[],"ees_conns":[],"enabled":false,"extra_fields":[],"online_cdr_exports":[],"rals_conns":[],"session_cost_retries":5,"stats_conns":[],"store_cdrs":true,"thresholds_conns":[]}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONSessionS(t *testing.T) {
	var reply string
	expected := `{"sessions":{"actions_conns":[],"alterable_fields":[],"attributes_conns":[],"cdrs_conns":[],"channel_sync_interval":"0","chargers_conns":[],"client_protocol":1,"debit_interval":"0","default_usage":{"*any":"3h0m0s","*data":"1048576","*sms":"1","*voice":"3h0m0s"},"enabled":false,"listen_bigob":"","listen_bijson":"127.0.0.1:2014","min_dur_low_balance":"0","rals_conns":[],"replication_conns":[],"resources_conns":[],"routes_conns":[],"session_indexes":[],"session_ttl":"0","stats_conns":[],"stir":{"allowed_attest":["*any"],"default_attest":"A","payload_maxduration":"-1","privatekey_path":"","publickey_path":""},"store_session_costs":false,"terminate_attempts":5,"thresholds_conns":[]}}`
	cfgCgr := NewDefaultCGRConfig()
