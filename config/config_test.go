...
func TestCgrCfgJSONDefaultsSureTax(t *testing.T) {
	...
	eSureTaxCfg := &SureTaxCfg{
		...
		ResponseType:         "D4",
		RegulatoryCode:       "03",
		ClientTracking:       NewRSRParsersMustCompile("~*req.*originID", utils.InfieldSep),
...
func TestV1GetConfigSuretax(t *testing.T) {
	...
	expected := map[string]interface{}{
		SureTaxJSON: map[string]interface{}{
			...
			utils.ClientTrackingCfg:       "~*req.*originID",
...
func TestV1GetConfigAsJSONSureTax(t *testing.T) {
	var reply string
	expected := `{"suretax":{"bill_to_number":"","business_unit":"","client_number":"","client_tracking":"~*req.*originID","customer_number":"~*req.Subject","include_local_cost":false,"orig_number":"~*req.Subject","p2pplus4":"","p2pzipcode":"","plus4":"","regulatory_code":"03","response_group":"03","response_type":"D4","return_file_code":"0","sales_type_code":"R","tax_exemption_code_list":"","tax_included":"0","tax_situs_rule":"04","term_number":"~*req.Destination","timezone":"UTC","trans_type_code":"010101","unit_type":"00","units":"1","url":"","validation_key":"","zipcode":""}}`
	cgrCfg := NewDefaultCGRConfig()
