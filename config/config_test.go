...
func TestCgrCfgJSONDefaultsCdreProfiles(t *testing.T) {
	eContentFlds := []*FCTemplate{
		...
		{
			Tag:       "*exp.RunID",
			Path:      utils.MetaExp + utils.NestingSep + "RunID",
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "RunID"}},
			pathSlice: []string{utils.MetaExp, "RunID"},
			Type:      "*composed",
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "ToR"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "OriginID"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "RequestType"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Tenant"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Category"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Account"}},
		...
		{
			Tag:       "*exp.Subject",
			Path:      utils.MetaExp + utils.NestingSep + "Subject",
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Subject"}},
			pathSlice: []string{utils.MetaExp, "Subject"},
			Type:      "*composed",
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Destination"}},
		...
		{
			Tag:       "*exp.SetupTime",
			Path:      utils.MetaExp + utils.NestingSep + "SetupTime",
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "SetupTime"}},
		...
		},
		{
			...
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "AnswerTime"}},
		...
		{
			Tag:       "*exp.Usage",
			Path:      utils.MetaExp + utils.NestingSep + "Usage",
			pathItems: utils.PathItems{{Field: utils.MetaExp}, {Field: "Usage"}},
			pathSlice: []string{utils.MetaExp, "Usage"},
			Type:      "*composed",
		...
		},
		{
			...
			pathItems:        utils.PathItems{{Field: utils.MetaExp}, {Field: "Cost"}},
			...
			Data: []*LoaderDataType{
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "Type", Path: "Type",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~2", true, utils.INFIELD_SEP)},
						{Tag: "Element", Path: "Element",
							pathItems: utils.PathItems{{Field: "Element"}},
							pathSlice: []string{"Element"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "Values", Path: "Values",
							pathItems: utils.PathItems{{Field: "Values"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ActivationInterval", Path: "ActivationInterval",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "TTL", Path: "UsageTTL",
							pathItems: utils.PathItems{{Field: "UsageTTL"}},
							pathSlice: []string{"UsageTTL"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~4", true, utils.INFIELD_SEP)},
						{Tag: "Limit", Path: "Limit",
							pathItems: utils.PathItems{{Field: "Limit"}},
							pathSlice: []string{"Limit"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~5", true, utils.INFIELD_SEP)},
						{Tag: "AllocationMessage", Path: "AllocationMessage",
							pathItems: utils.PathItems{{Field: "AllocationMessage"}},
						...
						{Tag: "Blocker", Path: "Blocker",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~7", true, utils.INFIELD_SEP)},
						{Tag: "Stored", Path: "Stored",
							pathItems: utils.PathItems{{Field: "Stored"}},
						...
						{Tag: "Weight", Path: "Weight",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~9", true, utils.INFIELD_SEP)},
						{Tag: "ThresholdIDs", Path: "ThresholdIDs",
							pathItems: utils.PathItems{{Field: "ThresholdIDs"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ActivationInterval", Path: "ActivationInterval",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "QueueLength", Path: "QueueLength",
							pathItems: utils.PathItems{{Field: "QueueLength"}},
							pathSlice: []string{"QueueLength"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~4", true, utils.INFIELD_SEP)},
						{Tag: "TTL", Path: "TTL",
							pathItems: utils.PathItems{{Field: "TTL"}},
							pathSlice: []string{"TTL"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~5", true, utils.INFIELD_SEP)},
						{Tag: "MinItems", Path: "MinItems",
							pathItems: utils.PathItems{{Field: "MinItems"}},
							pathSlice: []string{"MinItems"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~6", true, utils.INFIELD_SEP)},
						{Tag: "MetricIDs", Path: "MetricIDs",
							pathItems: utils.PathItems{{Field: "MetricIDs"}},
							pathSlice: []string{"MetricIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~7", true, utils.INFIELD_SEP)},
						{Tag: "MetricFilterIDs", Path: "MetricFilterIDs",
							pathItems: utils.PathItems{{Field: "MetricFilterIDs"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ActivationInterval", Path: "ActivationInterval",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "MaxHits", Path: "MaxHits",
							pathItems: utils.PathItems{{Field: "MaxHits"}},
							pathSlice: []string{"MaxHits"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~4", true, utils.INFIELD_SEP)},
						{Tag: "MinHits", Path: "MinHits",
							pathItems: utils.PathItems{{Field: "MinHits"}},
							pathSlice: []string{"MinHits"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~5", true, utils.INFIELD_SEP)},
						{Tag: "MinSleep", Path: "MinSleep",
							pathItems: utils.PathItems{{Field: "MinSleep"}},
						...
						{Tag: "Weight", Path: "Weight",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~8", true, utils.INFIELD_SEP)},
						{Tag: "ActionIDs", Path: "ActionIDs",
							pathItems: utils.PathItems{{Field: "ActionIDs"}},
							pathSlice: []string{"ActionIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~9", true, utils.INFIELD_SEP)},
						{Tag: "Async", Path: "Async",
							pathItems: utils.PathItems{{Field: "Async"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ActivationInterval", Path: "ActivationInterval",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "Sorting", Path: "Sorting",
							pathItems: utils.PathItems{{Field: "Sorting"}},
							pathSlice: []string{"Sorting"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~4", true, utils.INFIELD_SEP)},
						{Tag: "SortingParamameters", Path: "SortingParamameters",
							pathItems: utils.PathItems{{Field: "SortingParamameters"}},
							pathSlice: []string{"SortingParamameters"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~5", true, utils.INFIELD_SEP)},
						{Tag: "SupplierID", Path: "SupplierID",
							pathItems: utils.PathItems{{Field: "SupplierID"}},
							pathSlice: []string{"SupplierID"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~6", true, utils.INFIELD_SEP)},
						{Tag: "SupplierFilterIDs", Path: "SupplierFilterIDs",
							pathItems: utils.PathItems{{Field: "SupplierFilterIDs"}},
							pathSlice: []string{"SupplierFilterIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~7", true, utils.INFIELD_SEP)},
						{Tag: "SupplierAccountIDs", Path: "SupplierAccountIDs",
							pathItems: utils.PathItems{{Field: "SupplierAccountIDs"}},
							pathSlice: []string{"SupplierAccountIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~8", true, utils.INFIELD_SEP)},
						{Tag: "SupplierRatingPlanIDs", Path: "SupplierRatingPlanIDs",
							pathItems: utils.PathItems{{Field: "SupplierRatingPlanIDs"}},
							pathSlice: []string{"SupplierRatingPlanIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~9", true, utils.INFIELD_SEP)},
						{Tag: "SupplierResourceIDs", Path: "SupplierResourceIDs",
							pathItems: utils.PathItems{{Field: "SupplierResourceIDs"}},
							pathSlice: []string{"SupplierResourceIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~10", true, utils.INFIELD_SEP)},
						{Tag: "SupplierStatIDs", Path: "SupplierStatIDs",
							pathItems: utils.PathItems{{Field: "SupplierStatIDs"}},
							pathSlice: []string{"SupplierStatIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~11", true, utils.INFIELD_SEP)},
						{Tag: "SupplierWeight", Path: "SupplierWeight",
							pathItems: utils.PathItems{{Field: "SupplierWeight"}},
							pathSlice: []string{"SupplierWeight"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~12", true, utils.INFIELD_SEP)},
						{Tag: "SupplierBlocker", Path: "SupplierBlocker",
							pathItems: utils.PathItems{{Field: "SupplierBlocker"}},
							pathSlice: []string{"SupplierBlocker"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~13", true, utils.INFIELD_SEP)},
						{Tag: "SupplierParameters", Path: "SupplierParameters",
							pathItems: utils.PathItems{{Field: "SupplierParameters"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ActivationInterval", Path: "ActivationInterval",
							...
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP)},
						{Tag: "RunID", Path: "RunID",
							pathItems: utils.PathItems{{Field: "RunID"}},
							pathSlice: []string{"RunID"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~4", true, utils.INFIELD_SEP)},
						{Tag: "AttributeIDs", Path: "AttributeIDs",
							pathItems: utils.PathItems{{Field: "AttributeIDs"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "Strategy", Path: "Strategy",
							pathItems: utils.PathItems{{Field: "Strategy"}},
							pathSlice: []string{"Strategy"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~5", true, utils.INFIELD_SEP),
						},
						{Tag: "StrategyParameters", Path: "StrategyParameters",
							pathItems: utils.PathItems{{Field: "StrategyParameters"}},
							pathSlice: []string{"StrategyParameters"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~6", true, utils.INFIELD_SEP),
						},
						{Tag: "ConnID", Path: "ConnID",
							pathItems: utils.PathItems{{Field: "ConnID"}},
							pathSlice: []string{"ConnID"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~7", true, utils.INFIELD_SEP),
						},
						{Tag: "ConnFilterIDs", Path: "ConnFilterIDs",
							pathItems: utils.PathItems{{Field: "ConnFilterIDs"}},
							pathSlice: []string{"ConnFilterIDs"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~8", true, utils.INFIELD_SEP),
						},
						{Tag: "ConnWeight", Path: "ConnWeight",
							pathItems: utils.PathItems{{Field: "ConnWeight"}},
							pathSlice: []string{"ConnWeight"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~9", true, utils.INFIELD_SEP),
						},
						{Tag: "ConnBlocker", Path: "ConnBlocker",
							pathItems: utils.PathItems{{Field: "ConnBlocker"}},
							pathSlice: []string{"ConnBlocker"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~10", true, utils.INFIELD_SEP),
						},
						{Tag: "ConnParameters", Path: "ConnParameters",
							pathItems: utils.PathItems{{Field: "ConnParameters"}},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "ID", Path: "ID",
							...
							Value:     NewRSRParsersMustCompile("~1", true, utils.INFIELD_SEP),
							Mandatory: true},
						{Tag: "Address", Path: "Address",
							pathItems: utils.PathItems{{Field: "Address"}},
							pathSlice: []string{"Address"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~2", true, utils.INFIELD_SEP),
						},
						{Tag: "Transport", Path: "Transport",
							pathItems: utils.PathItems{{Field: "Transport"}},
							pathSlice: []string{"Transport"},
							Type:      utils.MetaVariable,
							Value:     NewRSRParsersMustCompile("~3", true, utils.INFIELD_SEP),
						},
						{Tag: "TLS", Path: "TLS",
							pathItems: utils.PathItems{{Field: "TLS"}},
	...
	eCfg := &ERsCfg{
		...
		Readers: []*EventReaderCfg{
			&EventReaderCfg{
				...
				Fields: []*FCTemplate{
					{Tag: utils.ToR, Path: utils.MetaCgreq + utils.NestingSep + utils.ToR,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.ToR}}, Type: utils.MetaVariable,
						Value: NewRSRParsersMustCompile("~*req.2", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.ToR}},
					{Tag: utils.OriginID, Path: utils.MetaCgreq + utils.NestingSep + utils.OriginID,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.OriginID}}, Type: utils.MetaVariable,
					...
					{Tag: utils.RequestType, Path: utils.MetaCgreq + utils.NestingSep + utils.RequestType,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.RequestType}}, Type: utils.MetaVariable,
					...
					{Tag: utils.Tenant, Path: utils.MetaCgreq + utils.NestingSep + utils.Tenant,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Tenant}}, Type: utils.MetaVariable,
						Value: NewRSRParsersMustCompile("~*req.6", true, utils.INFIELD_SEP), Mandatory: true, pathSlice: []string{utils.MetaCgreq, utils.Tenant}},
					{Tag: utils.Category, Path: utils.MetaCgreq + utils.NestingSep + utils.Category,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Category}}, Type: utils.MetaVariable,
					...
					{Tag: utils.Account, Path: utils.MetaCgreq + utils.NestingSep + utils.Account,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Account}}, Type: utils.MetaVariable,
					...
					{Tag: utils.Subject, Path: utils.MetaCgreq + utils.NestingSep + utils.Subject,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Subject}}, Type: utils.MetaVariable,
					...
					{Tag: utils.Destination, Path: utils.MetaCgreq + utils.NestingSep + utils.Destination,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Destination}}, Type: utils.MetaVariable,
					...
					{Tag: utils.SetupTime, Path: utils.MetaCgreq + utils.NestingSep + utils.SetupTime,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.SetupTime}}, Type: utils.MetaVariable,
					...
					{Tag: utils.AnswerTime, Path: utils.MetaCgreq + utils.NestingSep + utils.AnswerTime,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.AnswerTime}}, Type: utils.MetaVariable,
					...
					{Tag: utils.Usage, Path: utils.MetaCgreq + utils.NestingSep + utils.Usage,
						pathItems: utils.PathItems{{Field: utils.MetaCgreq}, {Field: utils.Usage}}, Type: utils.MetaVariable,
