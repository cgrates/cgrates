				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "RateUnit",
							Path:   "RateUnit",
							Type:   utils.MetaVariable,
							Value:  NewRSRParsersMustCompile("~*req.18", utils.InfieldSep),
							Layout: time.RFC3339,
						},
						{Tag: "RateIncrement",
							Path:   "RateIncrement",
							Type:   utils.MetaVariable,
							Value:  NewRSRParsersMustCompile("~*req.19", utils.InfieldSep),
							Layout: time.RFC3339,
						},
					},
				},
				...
				},
				{
					...
					Fields: []*FCTemplate{
						...
						{Tag: "BalanceCostIncrements",
							...
							Value:  NewRSRParsersMustCompile("~*req.11", utils.InfieldSep),
							Layout: time.RFC3339},
						{Tag: "BalanceCostAttributes",
							Path:   "BalanceCostAttributes",
							Type:   utils.MetaVariable,
							Value:  NewRSRParsersMustCompile("~*req.12", utils.InfieldSep),
							Layout: time.RFC3339},
