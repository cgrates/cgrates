...
func TestCgrCfgJSONDefaultsCdreProfiles(t *testing.T) {
	eContentFlds := []*FCTemplate{
		...
		{
			Tag:       "*exp.RunID",
			Path:      utils.PathItems{{Field: utils.MetaExp}, {Field: "RunID"}},
		...
		{
			Tag:       "*exp.Subject",
			Path:      utils.PathItems{{Field: utils.MetaExp}, {Field: "Subject"}},
		...
		{
			Tag:       "*exp.SetupTime",
			Path:      utils.PathItems{{Field: utils.MetaExp}, {Field: "SetupTime"}},
		...
		{
			Tag:       "*exp.Usage",
			Path:      utils.PathItems{{Field: utils.MetaExp}, {Field: "Usage"}},
