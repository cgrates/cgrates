			...
			utils.ReadersCfg: []map[string]interface{}{
				{
					...
					utils.OptsCfg: map[string]interface{}{
						utils.PartialCSVCacheExpiryActionOpt: utils.MetaPostCDR,
						"csvFieldSeparator":                  ",",
