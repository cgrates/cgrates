...
func TestERsLoadFromJSONCfg(t *testing.T) {
	...
	erJson := &EventReaderOptsJson{
		...
		PartialCacheAction:       utils.StringPointer("partialCacheAction"),
		PartialOrderField:        utils.StringPointer("partialOrderField"),
		PartialCSVFieldSeparator: utils.StringPointer(";"),
		CSVRowLength:             utils.IntPointer(2),
		CSVFieldSeparator:        utils.StringPointer(","),
		CSVHeaderDefineChar:      utils.StringPointer("headerDefineChar"),
		CSVLazyQuotes:            utils.BoolPointer(false),
		XMLRootPath:              utils.StringPointer("xmlRootPath"),
		AMQPQueueID:              utils.StringPointer("queueID"),
		AMQPConsumerTag:          utils.StringPointer("consumerTag"),
		AMQPExchange:             utils.StringPointer("exchange"),
		AMQPExchangeType:         utils.StringPointer("exchangeType"),
		...
		SQLTableName:             utils.StringPointer("cgratesT1"),
		...
		S3BucketID:               utils.StringPointer("bucketID"),
		NATSJetStream:            utils.BoolPointer(false),
		NATSConsumerName:         utils.StringPointer("consumerName"),
		NATSStreamName:           utils.StringPointer("streamName"),
		NATSSubject:              utils.StringPointer("subject"),
		NATSQueueID:              utils.StringPointer("queueID"),
		NATSJWTFile:              utils.StringPointer("jswFile"),
		NATSSeedFile:             utils.StringPointer("seedFile"),
...
func TestERsAsMapInterface(t *testing.T) {
	...
	exp := map[string]any{
		"opts": map[string]any{
			...
			"awsToken":                 "awsToken",
			"csvFieldSeparator":        ",",
			"csvHeaderDefineChar":      "headerDefineChar",
			"csvLazyQuotes":            false,
			"csvRowLength":             2,
