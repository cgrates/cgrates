	...
	fcTmpMp := map[string][]*FCTemplate{
		"TmpMap": []*FCTemplate{
			&FCTemplate{
				...
				Type:      "*composed",
				Path:      "Elem1",
				pathItems: utils.PathItems{{Field: "Elem1"}},
				pathSlice: []string{"Elem1"},
				Filters:   []string{"Filter1", "Filter2"},
			...
			&FCTemplate{
				...
				Type:      "*composed",
				Path:      "Elem2",
				pathItems: utils.PathItems{{Field: "Elem2"}},
				pathSlice: []string{"Elem2"},
				Filters:   []string{"Filter1_1", "Filter2_2"},
		...
		"TmpMap2": []*FCTemplate{
			&FCTemplate{
				...
				Type:      "*composed",
				Path:      "Elem2.1",
				pathItems: utils.PathItems{{Field: "Elem2.1"}},
				pathSlice: []string{"Elem2.1"},
				Filters:   []string{"Filter1", "Filter2"},
			...
			&FCTemplate{
				...
				Type:      "*composed",
				Path:      "Elem2.2",
				pathItems: utils.PathItems{{Field: "Elem2.2"}},
				pathSlice: []string{"Elem2.2"},
				Filters:   []string{"Filter1_1", "Filter2_2"},
