...
func TestLoaderSCfgloadFromJsonCfgCase1(t *testing.T) {
			...
			"loaders": [
	{
		...
		"conns": {"*caches": [{"connIDs": ["*internal","*conn1"]}]},
		"fieldSeparator": ",",
		"tpInPath": "/var/spool/cgrates/loader/in",
		"tpOutPath": "/var/spool/cgrates/loader/out",
		"data":[
			{
				"type": "*attributes",
	...
	expected := LoaderSCfgs{
		{
			...
			RunDelay:       0,
			LockFilePath:   ".cgr.lck",
			Conns:          map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{utils.ConcatenatedKey(utils.MetaInternal, utils.MetaCaches), "*conn1"}}}},
			FieldSeparator: ",",
...
func TestLoaderCfgAsMapInterfaceCase1(t *testing.T) {
			...
			"loaders": [												
	{
		...
		"runDelay": "0",										
		"lockfilePath": ".cgr.lck",
		"conns": {"*caches": [{"connIDs": ["*internal:*caches"]}]},
		"fieldSeparator": ",",
		"tpInPath": "/var/spool/cgrates/loader/in",		
		"tpOutPath": "/var/spool/cgrates/loader/out",		
		"data":[											
			...
			utils.DataCfg: []map[string]any{
				...
				},
				{
					...
					utils.FieldsCfg: []map[string]any{
						...
						{
							utils.TagCfg:       "PoolID",
							utils.PathCfg:      "Pools.ID",
							utils.TypeCfg:      "*variable",
							utils.ValueCfg:     "~*req.6",
							utils.NewBranchCfg: true,
						},
						{
							utils.TagCfg:   "PoolFilterIDs",
							utils.PathCfg:  "Pools.FilterIDs",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.7",
						},
						{
							utils.TagCfg:   "PoolType",
							utils.PathCfg:  "Pools.Type",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.8",
						},
						{
							utils.TagCfg:   "PoolRange",
							utils.PathCfg:  "Pools.Range",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.9",
						},
						{
							utils.TagCfg:   "PoolStrategy",
							utils.PathCfg:  "Pools.Strategy",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.10",
						},
						{
							utils.TagCfg:   "PoolMessage",
							utils.PathCfg:  "Pools.Message",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.11",
						},
						{
							utils.TagCfg:   "PoolWeights",
							utils.PathCfg:  "Pools.Weights",
							utils.TypeCfg:  "*variable",
							utils.ValueCfg: "~*req.12",
						},
						{
							utils.TagCfg:   "PoolBlockers",
							utils.PathCfg:  "Pools.Blockers",
							utils.TypeCfg:  "*variable",
				...
				},
				{
					...
					utils.FieldsCfg: []map[string]any{
						...
						{
							utils.TagCfg:     "ActionWeights",
							utils.PathCfg:    "Actions[<~*req.8>].Weights",
							utils.FiltersCfg: []string{"*notempty:~*req.8:"},
							utils.TypeCfg:    "*variable",
							utils.ValueCfg:   "~*req.13",
						},
						...
						{
							utils.NewBranchCfg: true,
							utils.TagCfg:       "ActionDiktatsID",
							utils.PathCfg:      "Actions[<~*req.8>].Diktats.ID",
							utils.FiltersCfg:   []string{"*notempty:~*req.8:"},
							utils.TypeCfg:      "*variable",
							utils.ValueCfg:     "~*req.15",
						},
						{
							utils.TagCfg:     "ActionDiktatsFilterIDs",
							utils.PathCfg:    "Actions[<~*req.8>].Diktats.FilterIDs",
							utils.FiltersCfg: []string{"*notempty:~*req.8:"},
							utils.TypeCfg:    "*variable",
							utils.ValueCfg:   "~*req.16",
						},
						{
							utils.TagCfg:     "ActionDiktatsOpts",
							utils.PathCfg:    "Actions[<~*req.8>].Diktats.Opts",
							utils.FiltersCfg: []string{"*notempty:~*req.8:"},
							utils.TypeCfg:    "*variable",
							utils.ValueCfg:   "~*req.17",
						},
						{
							utils.TagCfg:     "ActionDiktatsWeights",
							utils.PathCfg:    "Actions[<~*req.8>].Diktats.Weights",
							utils.FiltersCfg: []string{"*notempty:~*req.8:"},
							utils.TypeCfg:    "*variable",
							utils.ValueCfg:   "~*req.18",
						},
						{
							utils.TagCfg:     "ActionDiktatsBlockers",
							utils.PathCfg:    "Actions[<~*req.8>].Diktats.Blockers",
							utils.FiltersCfg: []string{"*notempty:~*req.8:"},
							utils.TypeCfg:    "*variable",
							utils.ValueCfg:   "~*req.19",
						},
					},
				},
				{
	...
	eMap := []map[string]any{
		{
			...
			utils.RunDelayCfg:     "0",
			utils.LockFilePathCfg: ".cgr.lck",
			utils.ConnsCfg:        map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{"*conn1"}}}},
			utils.FieldSepCfg:     ",",
			utils.TpInPathCfg:     "/var/spool/cgrates/loader/in",
			utils.TpOutPathCfg:    "/var/spool/cgrates/loader/out",
			utils.DataCfg: []map[string]any{
...
func TestLoaderSCfgsClone(t *testing.T) {
	...
	if (*rcv)[0].Conns[utils.MetaCaches][0].ConnIDs[1] = ""; ban[0].Conns[utils.MetaCaches][0].ConnIDs[1] != "*conn1" {
...
func TestDiffLoaderJsonCfg(t *testing.T) {
	...
	v1 := &LoaderSCfg{
		...
		Conns:          map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{"*localhost"}}}},
		FieldSeparator: ";",
		TpInDir:        "/tp/in/dir",
		TpOutDir:       "/tp/out/dir",
		Data:           nil,
	...
	v2 := &LoaderSCfg{
		...
		Conns:          map[string][]*DynamicConns{utils.MetaCaches: {{ConnIDs: []string{"*birpc"}}}},
		FieldSeparator: ":",
		TpInDir:        "/tp/in/dir/2",
