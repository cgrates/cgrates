...
func TestRatesCfgAsMapInterface1(t *testing.T) {
	cfgJSONStr := `{
     "rates": {
	        ...
	        "rateStringIndexedFields": ["*req.index1"],		
	        "ratePrefixIndexedFields": ["*req.index1", "*req.index2"],		
         	"rateSuffixIndexedFields": ["*req.index1", "*req.index2", "*req.index3"],	
			"rateExistsIndexedFields": ["*req.index1", "*req.index2"],			
            "rateNotExistsIndexedFields": ["*req.index1"],	
	        "rateNestedFields": true,			
     },
}`
	eMap := map[string]any{
