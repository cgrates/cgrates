...
func TestStatSCfgAsMapInterface1(t *testing.T) {
	cfgJSONStr := `{
		"stats": {
            ...
            "suffixIndexedFields":["*req.suffixIndexedFields"],
			"existsIndexedFields":["*req.existsIndexedFields"],
			"notExistsIndexedFields":["*req.notExistsIndexedFields"],
			"nestedFields": true,
		},
}`
	eMap := map[string]any{
		...
		utils.SuffixIndexedFieldsCfg:    []string{"*req.suffixIndexedFields"},
		utils.ExistsIndexedFieldsCfg:    []string{"*req.existsIndexedFields"},
		utils.NotExistsIndexedFieldsCfg: []string{"*req.notExistsIndexedFields"},
