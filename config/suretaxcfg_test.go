...
func TestSureTaxCfgloadFromJsonCfgCase1(t *testing.T) {
	cfgJSON := &SureTaxJsonCfg{
		...
		Term_number:             utils.StringPointer("~*opts.*originID"),
	...
	expected := &SureTaxCfg{
		...
		ResponseType:         "A3",
		RegulatoryCode:       "06",
		ClientTracking:       utils.NewRSRParsersMustCompile("~*req.Destination1", utils.InfieldSep),
		CustomerNumber:       utils.NewRSRParsersMustCompile("~*req.Destination1", utils.InfieldSep),
		OrigNumber:           utils.NewRSRParsersMustCompile("~*req.Destination1", utils.InfieldSep),
		TermNumber:           utils.NewRSRParsersMustCompile("~*opts.*originID", utils.InfieldSep),
...
func TestSureTaxCfgAsMapInterface(t *testing.T) {
	...
	"suretax": {
		...
		"responseType":           "A4",
		"regulatoryCode":         "04",
		"clientTracking":         "~*req.Destination",
		"customerNumber":         "~*req.Destination",
		"origNumber":             "~*req.Destination",
        "billToNumber": "randomNumber",					
	    "zipcode": "randomCode",							
	    "plus4": "randomValue",							
	    "p2pzipcode": "randomCode",						
	    "p2pplus4": "randomValue",
		"termNumber":             "~*opts.*originID",
		"units":                   "7",
		"unitType":               "02",
		"taxIncluded":            "1",
		"taxSitusRule":          "03",
		"transTypeCode":         "01010101",
		"salesTypeCode":         "B",
        "taxExemptionCodeList": "randomCode"
    },
}`
	eMap := map[string]any{
		...
		utils.TermNumberCfg:           "~*opts.*originID",
...
func TestDiffSureTaxJson(t *testing.T) {
	...
	v1 := &SureTaxCfg{
		...
		ResponseType:         "A4",
		RegulatoryCode:       "07",
		ClientTracking:       utils.NewRSRParsersMustCompile("~*req.Destination2", utils.InfieldSep),
		CustomerNumber:       utils.NewRSRParsersMustCompile("~*req.Destination2", utils.InfieldSep),
		OrigNumber:           utils.NewRSRParsersMustCompile("~*req.Destination2", utils.InfieldSep),
		TermNumber:           utils.NewRSRParsersMustCompile("~*opts.*originID2", utils.InfieldSep),
		BillToNumber:         utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
		Zipcode:              utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
		Plus4:                utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
		P2PZipcode:           utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
		P2PPlus4:             utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
		Units:                utils.NewRSRParsersMustCompile("2", utils.InfieldSep),
		UnitType:             utils.NewRSRParsersMustCompile("000", utils.InfieldSep),
		TaxIncluded:          utils.NewRSRParsersMustCompile("00", utils.InfieldSep),
		TaxSitusRule:         utils.NewRSRParsersMustCompile("05", utils.InfieldSep),
		TransTypeCode:        utils.NewRSRParsersMustCompile("01010101", utils.InfieldSep),
		SalesTypeCode:        utils.NewRSRParsersMustCompile("S", utils.InfieldSep),
		TaxExemptionCodeList: utils.NewRSRParsersMustCompile(utils.MetaNone, utils.InfieldSep),
	}
