...
func TestThresholdSCfgAsMapInterfaceCase2(t *testing.T) {
	cfgJSONStr := `{
		"thresholds": {
            ...
            "suffixIndexedFields": ["*req.suffixIndexedFields1", "*req.suffixIndexedFields2"],
	...
	eMap := map[string]any{
		...
		utils.SuffixIndexedFieldsCfg:    []string{"*req.suffixIndexedFields1", "*req.suffixIndexedFields2"},
