...
func TestActionsTransferBalance(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			name:        "NilAccount",
			expectedErr: "account cannot be nil for *transfer_balance action",
		},
		{
			...
			expectedErr: "balance type must be specified",
		},
		{
			...
			expectedErr: "source balance ID must be specified",
		},
		{
			...
			expectedErr: "destination account parameters required",
		},
		{
		...
		},
		{
			...
			expectedErr: "could not find source balance",
		},
		{
		...
		},
		{
			...
			expectedErr: "could not find destination balance",
		},
		{
			...
			expectedErr: "balance value is 0 or not specified",
		},
		{
			...
			expectedErr: "not enough funds in the source balance",
		},
		{
			name: "NotEnoughFundsInSourceBalance",
			srcAcc: &Account{
		...
		{
			name: "SourceBalanceFailedUpdate",
			srcAcc: &Account{
				ID: "cgrates.org:ACC_SRC_FAIL",
				BalanceMap: map[string]Balances{
					utils.MetaMonetary: {
						{
							ID:    "BALANCE_SRC",
			...
			expectedErr: "updating source account failed: SERVER_ERROR",
		},
		{
