...
func init() {
	...
	// StatMetrics
	gob.Register(new(utils.StatASR))
	gob.Register(new(utils.StatACD))
	gob.Register(new(utils.StatTCD))
	gob.Register(new(utils.StatACC))
	gob.Register(new(utils.StatTCC))
	gob.Register(new(utils.StatPDD))
	gob.Register(new(utils.StatDDC))
	gob.Register(new(utils.StatSum))
	gob.Register(new(utils.StatAverage))
	gob.Register(new(utils.StatDistinct))
	gob.Register(new(utils.StatHighest))
	gob.Register(new(utils.StatLowest))
	gob.Register(new(utils.StatREPSC))
	gob.Register(new(utils.StatREPFC))
