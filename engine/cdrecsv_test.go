...
func TestExportVoiceWithConvert(t *testing.T) {
	...
	cdreCfg.Fields = []*config.FCTemplate{
		...
		{
			Tag:   "*exp.RequestType",
			Path:  utils.MetaExp + utils.NestingSep + "RequestType",
			Type:  "*composed",
		...
		{
			Tag:   "*exp.Tenant",
			Path:  utils.MetaExp + utils.NestingSep + "Tenant",
			Type:  "*composed",
		...
		{
			Tag:   "*exp.Category",
			Path:  utils.MetaExp + utils.NestingSep + "Category",
			Type:  "*composed",
		...
		{
			Tag:   "*exp.Account",
			Path:  utils.MetaExp + utils.NestingSep + "Account",
			Type:  "*composed",
		...
		{
			Tag:    "*exp.AnswerTime",
			Path:   utils.MetaExp + utils.NestingSep + "AnswerTime",
			Type:   "*composed",
		...
		{
			Tag:     "*exp.UsageVoice",
			Path:    utils.MetaExp + utils.NestingSep + "UsageVoice",
			Type:    "*composed",
		...
		{
			Tag:     "*exp.UsageData",
			Path:    utils.MetaExp + utils.NestingSep + "UsageData",
			Type:    "*composed",
