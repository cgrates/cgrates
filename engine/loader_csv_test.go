...
`
	IPsCSVContent = `
#Tenant[0],Id[1],FilterIDs[2],ActivationInterval[3],TTL[4],Type[5],Addresses[6],Stored[7],Weight[8]
cgrates.org,IPs1,*string:~*req.Account:1001,2014-07-29T15:00:00Z,-1,ipv4,127.0.0.1/24,true,10
`
	StatsCSVContent = `
