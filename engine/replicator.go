...
// ReplicationTask used to save the failed replication task to file.
...
// NewReplicationTaskFromFile returns ReplicationTask from the file.
...
// WriteToFile writes in a file found at "path" the data needed in order to
// re-execute a failed replication task.
...
func (r *ReplicationTask) Execute() error {
