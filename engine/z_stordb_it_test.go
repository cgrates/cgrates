	...
	tpThresholds := []*utils.TPThresholdProfile{
		{
			...
			Tenant:           "cgrates.org",
			ID:               "Threshold1",
			FilterIDs:        []string{"*string:~*req.Account:1002", "*string:~*req.DryRun:*default", "*ai:~*req.AnswerTime:2014-07-29T15:00:00Z"},
			MaxHits:          -1,
			MinSleep:         "1s",
			Blocker:          true,
			Weight:           10,
		...
		},
		{
			...
			Tenant:           "cgrates.org",
			ID:               "Threshold2",
			FilterIDs:        []string{"*string:~*req.Destination:10", "*ai:~*req.AnswerTime:2015-07-29T15:00:00Z"},
			MaxHits:          -1,
			MinSleep:         "1s",
			Blocker:          true,
			Weight:           20,
