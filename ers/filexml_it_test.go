...
var (
	...
	xmlTests = []func(t *testing.T){
		...
		/*
			Reader flag was set to *dryRun since there is no way to retrieve CDRs.If the message was read
			and processed successfully, the following log should be encountered:

			<ERs> DRYRUN, reader: <XML_EmptyRoot>, CGREvent: <{
				"Tenant": "cgrates.org",
				"ID": "07e1e2f",
				"Event": {
					"Account": "1001",
					"AnswerTime": "20231011125801",
					"Category": "call",
					"Destination": "1002",
					"OriginID": "EmptyRootCDR_2",
					"RequestType": "*postpaid",
					"SetupTime": "20231011125800",
					"Tenant": "cgrates.org",
					"ToR": "*voice",
					"Usage": "32.158s"
				},
