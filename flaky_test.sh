...
packages=("agents" "apis" "attributes" "chargers" "cmd/cgr-console" "cmd/cgr-loader" "efs" "engine" "ers" "general_tests" "ips" "rankings" "registrarc" "resources" "routes" "sessions" "trends")
