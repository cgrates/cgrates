...
func testSectConfigSReloadChargers(t *testing.T) {
	...
	cfgStr := `{"chargers":{"conns":{"*attributes":[{"FilterIDs":null,"Tenant":"","ConnIDs":["*internal"]}]},"enabled":true,"exists_indexed_fields":[],"indexed_selects":true,"nested_fields":false,"notexists_indexed_fields":[],"prefix_indexed_fields":[],"suffix_indexed_fields":[]}}`
	var rpl string
	if err := testSectRPC.Call(context.Background(), utils.ConfigSv1GetConfigAsJSON, &config.SectionWithAPIOpts{
		Tenant:   "cgrates.org",
...
func testSectConfigSReloadResources(t *testing.T) {
	...
	cfgStr := `{"resources":{"conns":{"*thresholds":[{"FilterIDs":null,"Tenant":"","ConnIDs":["*internal"]}]},"enabled":true,"exists_indexed_fields":[],"indexed_selects":true,"nested_fields":false,"notexists_indexed_fields":[],"opts":{"*units":[{"FilterIDs":null,"Tenant":""}],"*usageID":[{"FilterIDs":null,"Tenant":""}],"*usageTTL":[{"FilterIDs":null,"Tenant":""}]},"prefix_indexed_fields":[],"store_interval":"-1ns","suffix_indexed_fields":[]}}`
	var rpl string
	if err := testSectRPC.Call(context.Background(), utils.ConfigSv1GetConfigAsJSON, &config.SectionWithAPIOpts{
		Tenant:   "cgrates.org",
...
func testSectConfigSReloadStats(t *testing.T) {
	...
	cfgStr := `{"stats":{"conns":{"*thresholds":[{"FilterIDs":null,"Tenant":"","ConnIDs":["*internal"]}]},"ees_exporter_ids":null,"enabled":true,"exists_indexed_fields":[],"indexed_selects":true,"nested_fields":false,"notexists_indexed_fields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"FilterIDs":null,"Tenant":""}],"*roundingDecimals":[]},"prefix_indexed_fields":[],"store_interval":"-1ns","store_uncompressed_limit":0,"suffix_indexed_fields":[]}}`
	var rpl string
	if err := testSectRPC.Call(context.Background(), utils.ConfigSv1GetConfigAsJSON, &config.SectionWithAPIOpts{
		Tenant:   "cgrates.org",
...
func testSectConfigSReloadThresholds(t *testing.T) {
	...
	cfgStr := `{"thresholds":{"conns":{"*actions":[{"FilterIDs":null,"Tenant":"","ConnIDs":["*internal"]}]},"ees_exporter_ids":[],"enabled":true,"exists_indexed_fields":[],"indexed_selects":true,"nested_fields":false,"notexists_indexed_fields":[],"opts":{"*profileIDs":[],"*profileIgnoreFilters":[{"FilterIDs":null,"Tenant":""}]},"prefix_indexed_fields":[],"store_interval":"-1ns","suffix_indexed_fields":[]}}`
	var rpl string
	if err := testSectRPC.Call(context.Background(), utils.ConfigSv1GetConfigAsJSON, &config.SectionWithAPIOpts{
		Tenant:   "cgrates.org",
