...
func TestCacheLimitedProfiles(t *testing.T) {
	...
	"data_db": {					
		...
		"db_user": "cgrates", 			
		"items":{
			"*accounts": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*reverse_destinations": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*destinations": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*rating_plans": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*rating_profiles": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*actions": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*action_plans": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
			"*account_action_plans": {"limit": 10, "ttl": "3s", "static_ttl": false, "remote":false, "replicate":false},
		 	}},
		"rals": {
			"enabled": true,
		},
