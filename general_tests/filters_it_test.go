...
func testV1FltrPopulateThreshold(t *testing.T) {
	...
	var result string
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetFilter, filter, &result); err != nil {
		t.Error(err)
	...
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetActionProfile, argsAP, &result); err != nil && err.Error() != utils.ErrExists.Error() {
	...
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetThresholdProfile, tPrfl, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FltrPopulateResourcesAvailableUnits(t *testing.T) {
	...
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetStatQueueProfile, statsPrf, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FltrAccounts(t *testing.T) {
	var resp string
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1RemoveThresholdProfile,
	...
	filter := engine.FilterWithAPIOpts{
		Filter: &engine.Filter{
			...
			Rules: []*engine.FilterRule{
				{
					Type:    "*gt",
					Element: "~*accounts.1001.Balances.VoiceBalance.Units",
...
func testV1FltrChargerSuffix(t *testing.T) {
	...
	var result string
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetChargerProfile, chargerProfile, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
	...
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetChargerProfile, chargerProfile2, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}
...
func testV1FltrAttributesPrefix(t *testing.T) {
	attributeProfile := &utils.APIAttributeProfileWithAPIOpts{
	...
	var result string
	if err := fltrRpc.Call(context.Background(), utils.AdminSv1SetAttributeProfile, attributeProfile, &result); err != nil {
		t.Error(err)
	} else if result != utils.OK {
		t.Error("Unexpected reply returned", result)
	}

	processedEv := &utils.AttributesProcessEventReply{
		AlteredFields: []*utils.FieldsAltered{
			{
	...
	var result2 *utils.AttributesProcessEventReply
