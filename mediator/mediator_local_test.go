...
func TestPostCdrs(t *testing.T) {
	...
	if storedCdrs, err := cdrStor.GetStoredCdrs(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Time{}, time.Time{}, false, false); err != nil {
		t.Error(err)
	...
	if nonErrorCdrs, err := cdrStor.GetStoredCdrs(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Time{}, time.Time{}, true, false); err != nil {
		t.Error(err)
...
func TestInjectCdrs(t *testing.T) {
	...
	if nonRatedCdrs, err := cdrStor.GetStoredCdrs(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Time{}, time.Time{}, true, true); err != nil {
		t.Error(err)
...
func TestRateCdrs(t *testing.T) {
	...
	if errRatedCdrs, err := cdrStor.GetStoredCdrs(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Time{}, time.Time{}, false, true); err != nil {
		t.Error(err)
