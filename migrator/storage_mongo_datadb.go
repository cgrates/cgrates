...
func (v1ms *mongoMigrator) getV3Stats() (v1st *utils.StatQueueProfile, err error) {
	if v1ms.cursor == nil {
	...
	v1st = new(utils.StatQueueProfile)
	if err := (*v1ms.cursor).Decode(v1st); err != nil {
		return nil, err
	}
	return v1st, nil
...
// get V2
func (v1ms *mongoMigrator) getV2Stats() (v2 *utils.StatQueue, err error) {
	if v1ms.cursor == nil {
...
// set v2
func (v1ms *mongoMigrator) setV2Stats(v2 *utils.StatQueue) (err error) {
