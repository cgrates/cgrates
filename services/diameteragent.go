...
func (s *DiameterAgent) Start(shutdown *utils.SyncedChan, registry *servmanager.Registry) error {
...
func (s *DiameterAgent) Shutdown(_ *servmanager.Registry) (err error) {
	s.mu.Lock()
	close(s.stopChan)
	s.da = nil
	s.mu.Unlock()
