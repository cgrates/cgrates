...
var attrs = &utils.AttributesProcessEventReply{
...
func TestSessionSV1ProcessMessageReplyAsNavigableMap(t *testing.T) {
	...
	tmpRoutes := utils.SortedRoutesList{{
		ProfileID: "Route1",
	}}
...
func TestV1ProcessEventReplyAsNavigableMap(t *testing.T) {
	...
	//attributes check
	v1per.Attributes = make(map[string]*utils.AttributesProcessEventReply)
	...
	nm := tmpRoutes.AsNavigableMap()
	v1per.RouteProfiles = make(map[string]utils.SortedRoutesList)
