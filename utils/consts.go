...
var (
	...
	PrimaryCdrFields = []string{CGRID, CDRSOURCE, CDRHOST, ACCID, TOR, REQTYPE, DIRECTION, Tenant, CATEGORY, Account, SUBJECT, Destination, SetupTime, PDD, AnswerTime, Usage,
