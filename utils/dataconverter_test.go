...
func TestStripConverter(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "Empty substr with -1 amount",
			params:         "*strip:*prefix:",
			input:          "TEST",
			expected:       "",
			constructorErr: true,
