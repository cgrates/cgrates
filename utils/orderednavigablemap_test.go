...
func TestOrderedNavigableMapString(t *testing.T) {
	var nm NMInterface = &OrderedNavigableMap{nm: NavigableMap2{"Field1": NewNMData("1001")}}
...
func TestOrderedNavigableMapSet(t *testing.T) {
	...
	if err := nm.Set(PathItems{{Field: "Field1", Index: IntPointer(10)}, {Field: "Field2"}}, NewNMData("1001")); err != ErrWrongPath {
		t.Error(err)
	}
	path := PathItems{{Field: "Field1", Index: IntPointer(0)}}
	expected := &OrderedNavigableMap{
		nm:    NavigableMap2{"Field1": &NMSlice{NewNMData("1001")}},
		order: []PathItems{path},
	}
	if err := nm.Set(path, NewNMData("1001")); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	if err := nm.Set(PathItems{{Field: "Field1", Index: IntPointer(0)}, {}}, NewNMData("1001")); err != ErrNotImplemented {
		t.Error(err)
	}
	if err := nm.Set(PathItems{{Field: "Field1", Index: IntPointer(10)}}, NewNMData("1001")); err != ErrWrongPath {
		t.Error(err)
	...
	expected = &OrderedNavigableMap{
		nm:    NavigableMap2{"Field1": &NMSlice{NewNMData("1002")}},
		order: []PathItems{path},
	}
	if err := nm.Set(path, NewNMData("1002")); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	...
	if err := nm.Set(path, NewNMData("1003")); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	...
	if err := nm.Set(PathItems{{Field: "Field3", Index: IntPointer(-1)}}, NewNMData("1007")); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
...
func TestOrderedNavigableMapSetField(t *testing.T) {
	...
	if err := nm.SetField(PathItem{Field: "Field1", Index: IntPointer(10)}, NewNMData("1001")); err != ErrWrongPath {
		t.Error(err)
	}
	...
	expected := &OrderedNavigableMap{
		nm:    NavigableMap2{"Field1": NewNMData(10)},
		order: []PathItems{{{Field: "Field1"}}},
	}
	if err := nm.SetField(PathItem{Field: "Field1"}, NewNMData(10)); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	...
	expected = &OrderedNavigableMap{
		nm:    NavigableMap2{"Field1": NewNMData(11)},
		order: []PathItems{{{Field: "Field1"}}},
	}
	if err := nm.SetField(PathItem{Field: "Field1"}, NewNMData(11)); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	expected = &OrderedNavigableMap{
		nm: NavigableMap2{
			"Field1": NewNMData(11),
			"Field2": &NMSlice{NewNMData("1005"), NewNMData("1006")},
		},
		order: []PathItems{{{Field: "Field1"}}, {{Field: "Field2", Index: IntPointer(0)}}, {{Field: "Field2", Index: IntPointer(1)}}},
	}
	if err := nm.SetField(PathItem{Field: "Field2"}, &NMSlice{NewNMData("1005"), NewNMData("1006")}); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
	expected = &OrderedNavigableMap{
		nm: NavigableMap2{
			"Field1": NewNMData(11),
			"Field2": &NMSlice{NewNMData("1007")},
		},
		order: []PathItems{{{Field: "Field1"}}, {{Field: "Field2", Index: IntPointer(0)}}},
	}
	if err := nm.SetField(PathItem{Field: "Field2"}, &NMSlice{NewNMData("1007")}); err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(nm, expected) {
		t.Errorf("Expected %s ,received: %s", expected, nm)
	}
...
func TestOrderedNavigableMapRemove(t *testing.T) {
	...
	nm = &OrderedNavigableMap{
		nm: NavigableMap2{
			"Field1": NewNMData("1001"),
			"Field2": NewNMData("1003"),
			"Field6": NavigableMap2{"Field8": NewNMData("Val")},
			"Field3": NavigableMap2{
				"Field4": NewNMData("Val"),
				"Field7": &NMSlice{NewNMData(103), NewNMData(102)},
			},
			"Field5": &NMSlice{NewNMData(10), NewNMData(101)},
		},
		order: []PathItems{
